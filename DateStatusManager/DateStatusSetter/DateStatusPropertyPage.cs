...
namespace DateStatusSetter {
    public partial class DateStatusPropertyPage : SharpPropertyPage {
        ...
        #region Constructors
        public DateStatusPropertyPage(string path) => new DateStatusPropertyPage(new string[] { path });
        public DateStatusPropertyPage(string[] paths) {
            InitializeComponent();
            CheckBoxes = new CheckBox[] { lastAccessCheckBox, lastWriteCheckBox, creationCheckBox };
            Pickers = new DateTimePickerExtended[] { lastAccessDateTimePicker, lastWriteDateTimePicker, creationDateTimePicker };
            if (paths.Length == 0)
        ...
        protected static void UpdateUnknownComponent(DateTime original, DateTime @new, ref DateTimeComponent unknown) {
            DateTimeComponent comp = DateTimeComponent.Year;
            do {
    ...
    public sealed class DateTimePickedEventArgs : EventArgs {
        internal DateTimePickedEventArgs(int index) : base() => PickerIndex = index;
